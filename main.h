...
void saveSectorsToFile(t_app_state *app_state, string filepath);
void loadSectorsFromFile(t_app_state *app_state, string filepath);
void saveSensorsToFile(t_app_state *app_state, string filepath);
void loadSensorsFromFile(t_app_state *app_state, string filepath);
void saveInspectionsToFile(t_app_state *app_state, string filepath);
